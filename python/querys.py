...
# trunca/carga 
def insert_01_otc_t_b2b_terminales_adendum(fecha_proceso):
    qry="""
SELECT
	*
FROM
...
def insert_02_otc_t_b2b_terminales_adendum(fecha_proceso):
    qry="""
SELECT
	CASE
		WHEN M.des_brand IS NULL THEN 'NO DEFINIDO'
...
## N04 --EXTRAER NOTAS DE CREDITO BILL SEG
def otc_t_b2b_temp_notas_credito(fecha_proceso):
    qry="""
SELECT
...
## N05 --EXTRAER LA FACTURA AFECTADA CON LA NOTA DE CREDITO
def otc_t_b2b_temp_factura_afectada(fecha_proceso):
    qry="""
SELECT
	A.account_num AS cuenta_facturacion,
...
## N06 --EXTRAER AJUSTES EFECTUADOS A LA NOTA DE CREDITO
def otc_t_b2b_temp_ajustes_nota_credito(fecha_proceso):
    qry="""
SELECT
	A.*,
	C.dispute_seq
...
## N07 --EXTRAE DISPUTA DE LA FACTURA AFECTADA POR LA NOTA DE CREDITO
def otc_t_b2b_temp_disputa(fecha_proceso):
    qry="""
SELECT
	F.*,
	E.DISPUTE_TYPE_NAME
...
## N08 --Extraer facturaciOn de tres meses posteriores incluyendo mes actual y alimentar tabla de fecturacion otc_t_b2b_facturacion

def otc_t_b2b_facturacion(fecha_proceso):
    qry="""
SELECT
